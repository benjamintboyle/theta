...
public class PositionLogger {
    ...
    private static final Comparator<Security> byStockIsGreaterThanOptions = (s1, s2) -> {
    ...
    private static final Comparator<Security> byPrice = Comparator.comparing(Security::getPrice);

    private static final Comparator<Security> byCallIsGreaterThanPut = (s1, s2) -> {
