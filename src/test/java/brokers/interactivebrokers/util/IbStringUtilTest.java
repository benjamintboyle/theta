...
class IbStringUtilTest {
  ...
  @Test
  public void testToStringOrderState()
  ...
  public void testToStringOrder() {
    ...
    assertThat("Found '@' which likely indicates an unexpanded reference.", toStringOrder,
        not(containsString("@")));
  }
  ...
  void testToStringContract() {
    ...
    assertThat("Found '@' which likely indicates an unexpanded reference.", toStringContract,
        not(containsString("@")));
  }

  @Test
  public void testToStringContractNull() {
  ...
  @Test
  public void testToStringDeltaNeutralContractEmpty() {
    final String toStringDeltaNeutralContractEmpty =
        IbStringUtil.toStringDeltaNeutralContract(new DeltaNeutralContract());

    assertThat("toString() should not be empty.", toStringDeltaNeutralContractEmpty,
        is(not(emptyString())));
    assertThat("Found '@' which likely indicates an unexpanded reference.",
        toStringDeltaNeutralContractEmpty, not(containsString("@")));
  }

  @Test
  public void testToStringDeltaNeutralContractNull() {
  ...
  @Test
  public void testToStringComboLegEmpty() {
  ...
  @Test
  public void testToStringComboLegNull() {
